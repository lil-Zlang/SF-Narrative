  ...
  try {
    ...
    await prisma.weeklyNews.create({
      data: {
        ...
        techSources: techArticles.slice(0, 10) as any,
        techKeywords: techData.keywords as any,
        
        politicsSummary: politicsData.summaryShort,
        politicsDetailed: politicsData.summaryDetailed,
        politicsBullets: politicsData.bullets as any,
        politicsSources: politicsArticles.slice(0, 10) as any,
        politicsKeywords: politicsData.keywords as any,
        
        economySummary: economyData.summaryShort,
        economyDetailed: economyData.summaryDetailed,
        economyBullets: economyData.bullets as any,
        economySources: economyArticles.slice(0, 10) as any,
        economyKeywords: economyData.keywords as any,
        
        sfLocalSummary: sfLocalData.summaryShort,
        sfLocalDetailed: sfLocalData.summaryDetailed,
        sfLocalBullets: sfLocalData.bullets as any,
        sfLocalSources: sfLocalArticles.slice(0, 10) as any,
        sfLocalKeywords: sfLocalData.keywords as any,
